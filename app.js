...
const premiumBreathworkRoutines = [
  ...
  ["Day 6", "New Morning Mercies", "6-8 minutes", "Morning breath prayer", "Beginning again", "Lamentations 3:22-23", "Begin the day by receiving mercy rather than pressure. Pray: Inhale, Your mercies are new. Exhale, I begin again with You. Let God's faithfulness meet the new morning before your tasks do.", "Morning light, open window, walking path, fresh green and gold palette.", "Hopeful, gentle, and clear, with a fresh-start feeling that does not rush.", "Faithful God, thank You that Your mercies are new this morning. Help me begin again with You."],
  ["Day 7", "Strength for the Next Step", "6-8 minutes", "Strength-renewing breath prayer", "Endurance", "Isaiah 40:31", "Use this when you feel tired, stretched thin, or unsure how to keep going. Pray: Inhale, I wait on You. Exhale, Renew my strength. Ask God for strength for the next faithful step, not the entire road at once.", "Open trail, mountain sky, steady movement imagery, peaceful strength rather than intensity.", "Steady and encouraging, with room for honest fatigue and renewed courage.", "Lord, renew my strength as I wait on You. Help me take the next faithful step."],
