...
const ABIDE_BREATHWORK_WEEK_ONE_COUNT = 12;
...
const premiumBreathworkRoutines = [
  ...
  ["Day 2", "Receive God's Peace", "Finished video", "Natural breath prayer", "Peace", "John 14:27", "Begin seated, standing, or lying down. Let your shoulders soften, your jaw relax, and your hands rest open. Pray: Inhale, Jesus, You are near. Exhale, I receive God's peace. Notice tension without judgment and bring it into prayer. Pray: Your peace is a gift. I do not have to strive. Then bring one concern before the Lord and pray: I give this to You. Hold me in Your peace.", "Finished Abide video with peaceful visuals, opening logo card, and ending card.", "Warm and calm, emphasizing that peace is received from Jesus rather than forced.", "Lord Jesus, thank You that Your peace is not fragile or dependent on perfect circumstances. Help me walk into the rest of this day with a quieter heart, a steadier mind, and deeper trust in Your presence.", "https://www.youtube.com/embed/Ni_pIWldPQQ", "youtube"],
  ["Day 3", "When I Feel Anxious", "Finished video", "4-in, 6-out breath prayer", "Anxiety and prayer", "Philippians 4:6-7", "Begin in a steady, comfortable position. Breathe in for 4 and out for 6. Pray: Inhale, God, You are here. Exhale, I bring this to You. Name one anxious thought before God, then receive His peace without pretending the concern is not real.", "Finished Abide video with peaceful visuals and space to bring anxious thoughts honestly before God.", "Gentle, grounded, and reassuring with longer exhale counts and calm silence.", "God of peace, I bring You what makes me anxious. Guard my heart and mind in Christ Jesus.", "https://www.youtube.com/embed/z0js-TcXC4U", "youtube"],
  ["Day 4", "Abide in God's Love", "Finished video", "Natural breath prayer", "Remaining in love", "John 15:9", "Settle into a supported posture. Let the prayer become: Inhale, God, You love me. Exhale, Help me abide. Rest in the truth that you do not have to earn your way into God's love; you are invited to remain in it.", "Finished Abide video with warm, peaceful visuals and a gentle invitation to remain in God's love.", "Tender and unhurried, with the feel of an invitation rather than a lesson.", "Lord Jesus, help me remain in God's love and walk from that secure place.", "https://www.youtube.com/embed/sCQ8OL8nGXI", "youtube"],
  ...
  ["Day 9", "Clear Thinking", "Finished video", "Box breathing", "Wisdom and clear thinking", "James 1:5", "Find a comfortable position. Let your hands rest easily. Unclench your jaw. If any breath pattern feels uncomfortable, return to normal breathing. This practice is a way to slow down and ask God for wisdom. Our Scripture today is James 1:5: If any of you lacks wisdom, let him ask God. Take a natural breath in, and slowly breathe out. We will use a simple box breath. Breathe in for four. Hold gently for four. Breathe out for four. Hold gently for four. Only hold if it feels comfortable. Inhale: God of wisdom. Hold: I am listening. Exhale: Order my thoughts. Hold: Lead me in peace. Again. Inhale: God of wisdom. Hold: I am listening. Exhale: Order my thoughts. Hold: Lead me in peace. Now bring one decision, one task, or one mental knot before God. Do not try to solve it all right now. Simply name it in His presence. Ask Him for wisdom without shame. God is generous. God is not annoyed by your need. God is not confused by your confusion. Inhale: Give me wisdom. Exhale: Make the next step clear. Inhale: Give me wisdom. Exhale: Make the next step clear. Take three quiet breaths. Lord, I ask for wisdom. Clear away panic, pride, distraction, and fear. Help me think with humility and courage. Guide my choices through Your Word, Your Spirit, wise counsel, and the fruit of peace. I do not need every answer at once. I trust You for the next faithful step. Amen.", "Finished Abide video with calm, spacious visuals that support mental clarity and listening prayer.", "Steady, focused, and peaceful, with clear breath counts and unhurried pauses.", "God of wisdom, order my thoughts, quiet my fear, and guide my next faithful step.", "https://www.youtube.com/embed/CddFDfu7-xg", "youtube"],
  ["Day 10", "Confidence", "Finished video", "5-in, 5-out breath prayer", "Courage rooted in God's presence", "Joshua 1:9", "Settle into a steady posture. Let your spine rise gently. Let your shoulders relax. If you feel uncomfortable or lightheaded, return to normal breathing. Biblical confidence is not self-reliance. It is courage rooted in God's presence. Our Scripture today is Joshua 1:9: Be strong and courageous. Do not be frightened, and do not be dismayed, for the Lord your God is with you wherever you go. Take a slow breath in, and slowly breathe out. We will breathe evenly. Inhale for five. Exhale for five. Inhale: God is with me. Exhale: I can be courageous. Inhale: God is with me. Exhale: I can be courageous. Notice where fear has been making you small. Maybe in your voice, maybe in your obedience, maybe in a conversation, maybe in a new responsibility. You do not have to shame the fear. Just bring it to God. Inhale: You are with me. Exhale: I will take the next step. Inhale: You are with me. Exhale: I will take the next step. Let your body hear the truth: you are not alone, you are not abandoned, and you are not walking in your own strength. Take three steady breaths. Lord, make me strong and courageous, not because I feel ready, but because You are with me. Help me stop shrinking back from obedience. Give me humility without insecurity, courage without pride, and confidence that depends on Your presence. Lead me into the next faithful thing. You are with me wherever I go. Amen.", "Finished Abide video with steady, grounded visuals that support courage without rushing.", "Encouraging and grounded, with calm five-count breathing and space to bring fear honestly to God.", "Lord, make me strong and courageous because You are with me. Lead me into the next faithful thing.", "https://www.youtube.com/embed/99FakRMugEg", "youtube"],
  ["Day 11", "Focus Flow", "Finished video", "One breath, one faithful task", "Attention as worship", "Colossians 3:23", "Find a comfortable seated or standing position. Let your eyes soften. Let your breath become easy. If the breathing feels uncomfortable, return to your natural rhythm. This prayer is for returning your attention to God and the faithful work in front of you. Our Scripture today is Colossians 3:23: Whatever you do, work heartily, as for the Lord and not for men. Take a slow breath in, and gently breathe out. Inhale: Lord, receive my attention. Exhale: This work is for You. Inhale: Lord, receive my attention. Exhale: This work is for You. Think of one task in front of you today. Not the whole list. Just one task. Let that task become an offering instead of a pressure. Inhale: One breath. Exhale: One faithful task. Inhale: One breath. Exhale: One faithful task. When distraction comes, do not fight it harshly. Notice it. Release it. Return to God. Again: notice, release, return. Inhale: My mind returns to You. Exhale: My hands serve You. Inhale: My mind returns to You. Exhale: My hands serve You. Take three quiet breaths. Lord, help me work with a whole heart. Free me from performing for approval, rushing from fear, or scattering my attention in every direction. Let the next task become worship. Teach me to focus with peace, diligence, and love. My work belongs to You. My pace belongs to You. Amen.", "Finished Abide video with calm, focused visuals that turn ordinary work into prayerful offering.", "Minimal, steady, and focused, with simple repetition and peaceful space between phrases.", "Lord, receive my attention. Let the next task become worship, and help me work with a whole heart before You.", "https://www.youtube.com/embed/oF2SjFIbciE", "youtube"],
  ["Day 12", "Productivity Reset", "Finished video", "4-in, 4-hold, 6-out", "Resetting hurry and inviting God into your time", "Psalm 90:12", "Begin by letting your shoulders soften and your breath slow. Breathe in for 4, hold gently for 4, and exhale for 6. Let hurry leave your body and bring the work, tasks, and pressure in front of you to God. Pray: Teach me to number my days. Order my time. Help me do the next faithful thing with peace.", "Finished Abide video with calm productivity reset visuals, gentle focus, and a peaceful invitation to let God order the day.", "Practical, calm, lightly directive, and peaceful rather than pressured.", "Lord, teach me to number my days. Order my time, quiet my hurry, and help me do the next faithful thing with You.", "https://www.youtube.com/embed/AJ3IMZKvrB8", "youtube"],
...
const premiumWalkingSessions = [
  ["Walk 1", "Begin the Day With God", "15 minutes", "Easy pace", "Psalm 143:8", "Start the day by giving your attention, plans, and pace to God.", "The script opens with safety, Psalm 143:8, and the breath prayer: Lord, I receive Your love / Show me the way to go. The walk moves through naming the day, asking for one faithful step, praying for someone ahead, and closing in gratitude.", "What needs to be surrendered before the day begins? Who needs prayer before I see them today?", "Sunrise path, neighborhood sidewalk, soft instrumental music", "Lord, let me hear Your steadfast love this morning and show me the way I should go."],
  ["Walk 2", "Cast Your Cares", "20 minutes", "Slow steady pace", "1 Peter 5:7", "Use your walk to release worry into God's care instead of carrying it alone.", "The script uses the breath prayer: Father, You care for me / I release this to You. It guides honest naming, open-handed release, receiving God's personal care, and returning lighter without denying what is still present.", "What care keeps returning to my mind? What would trusting God with it look like today?", "Tree-lined trail, cloudy sky clearing, gentle ambient sound", "Father, I cast these cares on You because You care for me."],
  ["Walk 3", "Gratitude Walk", "15 minutes", "Comfortable pace", "Psalm 107:1", "Train your attention toward God's gifts through embodied thanksgiving.", "The script uses the breath prayer: Lord, You are good / Thank You for this gift. It guides users to name ordinary gifts, linger over one overlooked mercy, and ask God to make gratitude visible in their words and choices.", "What ordinary gift has become too familiar? How can gratitude reshape my attitude today?", "Garden path, flowers, warm daylight", "Thank You, Lord, for Your steadfast love and daily goodness."],
  ["Walk 4", "Prayer for Others", "25 minutes", "Easy to moderate pace", "1 Timothy 2:1", "Turn movement into intercession for family, friends, community, and the world.", "The script uses the breath prayer: Lord, teach me to pray / Make me generous in love. It moves through prayer for close relationships, someone struggling, the community, leaders, neighbors, and someone difficult to love.", "Who needs prayer, encouragement, or practical help today? Who is hard for me to pray for?", "Neighborhood walk, city park, wide community shots", "Lord, make me faithful in prayer and generous in love."],
  ["Walk 5", "Peace in the Middle", "20 minutes", "Gentle pace", "Philippians 4:6-7", "Bring anxiety to God and let His peace guard your heart while you move.", "The script uses the breath prayer: God is near / I receive Your peace. It invites one unsettled request, adds thanksgiving, and imagines God's peace guarding the heart and mind in Christ Jesus.", "What request do I need to bring to God with thanksgiving? Where do I need peace to guard me?", "Quiet path near water, soft blue-green tones", "God of peace, guard my heart and mind in Christ Jesus."],
  ["Walk 6", "Wisdom Walk", "20 minutes", "Thoughtful pace", "James 1:5", "Seek God's wisdom for a choice, conversation, or next step.", "The script uses the breath prayer: Generous God, give wisdom / Help me receive it humbly. It guides the user to describe the decision, separate wisdom from fear or impulse, and name one wise next step.", "What decision needs wisdom rather than impulse? What counsel or Scripture should I seek before acting?", "Forked trail, open Bible before walking, calm focus music", "Generous God, give me wisdom and help me receive it with humility."],
  ["Walk 7", "Forgiveness Walk", "25 minutes", "Slow pace", "Ephesians 4:32", "Begin releasing resentment while asking God for wisdom, boundaries, and mercy.", "The script uses the breath prayer: Jesus, meet me here / Lead me toward freedom. It names hurt honestly, asks what forgiveness does and does not require, and prays for healing, wise boundaries, confession where needed, and freedom.", "What am I still rehearsing? What boundary, confession, or prayer might help me move toward freedom?", "Open field, path forward, soft wind", "Jesus, lead me toward forgiveness, healing, and wise freedom."],
  ["Walk 8", "Strength Renewed", "30 minutes", "Moderate pace", "Isaiah 40:31", "Let a longer walk remind you that endurance comes from waiting on the Lord.", "The script uses the breath prayer: I wait on You / Renew my strength. It begins gently, names where the body and heart feel tired, steadies into endurance, then cools down with gratitude for how God has carried the user.", "Where have I confused forcing with faithfulness? How can I wait on God while still taking faithful steps?", "Long trail, mountain or open sky, steady rhythm", "Lord, renew my strength as I wait on You."],
  ["Walk 9", "Walk Humbly", "20 minutes", "Easy pace", "Micah 6:8", "Practice justice, mercy, and humility while walking with God.", "The script uses the breath prayer: Teach me justice / Teach me mercy and humility. It asks where justice needs to become visible, who needs mercy, and what humility would look like in the next conversation or responsibility.", "Where can I act justly? Who needs mercy from me? What would humility look like in my next conversation?", "Simple neighborhood walk, real-life ordinary setting", "Teach me to do justice, love mercy, and walk humbly with You."],
  ["Walk 10", "Evening Examen Walk", "15 minutes", "Slow reflective pace", "Psalm 139:23-24", "Review the day with God before rest.", "The script uses the breath prayer: Search me, Lord / Lead me in Your way. It reviews the day with gratitude, then honesty, then mercy, asking what to release tonight and what to carry into tomorrow with wisdom.", "Where did I notice God today? What do I need to confess, release, or carry into tomorrow with wisdom?", "Sunset path, quiet street, evening light", "Search me, Lord, and lead me in the way everlasting."],
  ["Walk 11", "Hope After Hardship", "20 minutes", "Gentle pace", "Romans 15:13", "Make space for hope without pretending hardship is easy.", "The script uses the breath prayer: God of hope, be near / Fill me as I trust You. It names what hurts honestly, names what remains true about God, and lets each step become a small act of hope.", "What pain needs honesty? What promise or truth helps me take the next step?", "Dawn after rain, open path", "God of hope, fill me with peace as I trust You."],
  ["Walk 12", "Celebration Walk", "30 minutes", "Joyful comfortable pace", "Psalm 150:6", "Celebrate God's faithfulness and mark progress with embodied praise.", "The script uses the breath prayer: Lord, I praise You / Thank You for walking with me. It recalls answered prayers, completed steps, growth, endurance, and grace, then turns celebration into testimony, worship, generosity, and continued faithfulness.", "What has God brought me through? What growth should I celebrate instead of rushing past?", "Bright trail, sunlight through trees, joyful but peaceful music", "Let everything in me praise You, Lord. Thank You for walking with me."]
...
const walkPathShortCopy = {
  Pause: "Slow down and notice God.",
  Pray: "Speak honestly with God.",
  Listen: "Receive Scripture slowly.",
  Walk: "Move and pray with God.",
  Live: "Let faith become action.",
  Remember: "Mark what God is forming.",
  Share: "Encourage someone else."
};
...
function renderAccessGate() {
  ...
  if (!abideUnlocked) {
    ["breathwork", "faithYoga", "bibleStudy", "walking"].forEach((panelId) => {
  ...
  pathSteps.innerHTML = walkPathSteps
    .map((step) => `
      <article class="path-step ${step.name === activeStep.name ? "is-active" : ""}">
        ...
        <div>
          <h3>${step.name}</h3>
          <p class="path-full-copy">${step.summary}</p>
          <p class="path-short-copy">${walkPathShortCopy[step.name] || step.summary}</p>
...
function renderBreathwork() {
  ...
  breathworkLockNote.textContent = isUnlocked
    ? "Abide access is open."
    : "Abide breathwork will open with Abide enrollment.";
  ...
  breathworkPurpose.textContent = hasFinishedVideo && isAdmin
    ...
    : `${routine.purpose}${isUnlocked ? "" : " - Coming with Abide enrollment."}`;
  ...
  breathworkScript.innerHTML = isUnlocked
    ...
    : `<p>Full breath prayer guidance will open with Abide enrollment.</p>`;
  if (breathworkMediaCard && breathworkAudio && breathworkVideo && breathworkYoutube && breathworkAudioNote) {
    ...
    if (canPlayMedia) {
      ...
      if (breathworkMediaLabel) breathworkMediaLabel.textContent = isVideo ? "Admin-Only Abide Video" : "Admin-Only Abide Audio";
  ...
  if (!hasFinishedVideo) {
    breathworkVisual.textContent = isUnlocked ? routine.visual : "Visual notes will open with Abide enrollment.";
    breathworkVoice.textContent = isUnlocked ? routine.voice : "Recording notes will open with Abide enrollment.";
    breathworkPrayer.textContent = isUnlocked ? routine.prayer : "Prayer text will open with Abide enrollment.";
  }
}
...
function renderYoga() {
  ...
  yogaLockNote.textContent = isUnlocked
    ? "Abide access is open."
    : "Faith-led movement will open with Abide enrollment.";
  ...
  yogaIntention.textContent = `${session.intention} ${isUnlocked ? "Modify any pose and rest whenever needed." : "Coming with Abide enrollment."}`;
  yogaFlow.innerHTML = isUnlocked
    ? `<p>${escapeHtml(session.flow)}</p>`
    : `<p>Full movement guidance will open with Abide enrollment.</p>`;
  yogaVisual.textContent = isUnlocked ? session.visual : "Visual notes will open with Abide enrollment.";
  yogaVoice.textContent = isUnlocked ? session.voice : "Recording notes will open with Abide enrollment.";
  yogaPrayer.textContent = isUnlocked ? session.prayer : "Prayer text will open with Abide enrollment.";
}
...
function renderBibleStudy() {
  ...
  bibleStudyLockNote.textContent = isUnlocked
    ? "Abide access is open."
    : "Guided Bible studies will open with Abide enrollment.";
  ...
  bibleStudyAim.textContent = `${study.aim} ${isUnlocked ? "" : "Coming with Abide enrollment."}`;
  bibleStudyOutline.innerHTML = isUnlocked
    ? `<p>${escapeHtml(study.outline)}</p>`
    : `<p>Full teaching notes will open with Abide enrollment.</p>`;
  bibleStudyQuestions.textContent = isUnlocked ? study.questions : "Discussion questions will open with Abide enrollment.";
  bibleStudyPractice.textContent = isUnlocked ? study.practice : "Practice steps will open with Abide enrollment.";
  bibleStudyPrayer.textContent = isUnlocked ? study.prayer : "Prayer text will open with Abide enrollment.";
}
...
function renderWalking() {
  ...
  walkingLockNote.textContent = isUnlocked
    ? "Abide access is open."
    : "Guided walking sessions will open with Abide enrollment.";
  ...
  walkingIntention.textContent = `${walk.intention} ${isUnlocked ? "Choose a safe route and adjust pace as needed." : "Coming with Abide enrollment."}`;
  walkingGuide.innerHTML = isUnlocked
    ? `<p>${escapeHtml(walk.guide)}</p>`
    : `<p>Full walking guidance will open with Abide enrollment.</p>`;
  walkingPrompts.textContent = isUnlocked ? walk.prompts : "Prayer prompts will open with Abide enrollment.";
  walkingVisual.textContent = isUnlocked ? walk.visual : "Audio notes will open with Abide enrollment.";
  walkingPrayer.textContent = isUnlocked ? walk.prayer : "Prayer text will open with Abide enrollment.";
}
...
document.addEventListener("click", (event) => {
  ...
  if (state.premiumPanels[panelId]) localStorage.setItem("walkWithGodAbideAccessOpened", "true");
  savePremiumPanels();
  renderPremiumPanels();
});
  ...
  premiumContentForm.addEventListener("submit", (event) => {
    ...
    apiFetch("/api/admin/premium-content", {
      ...
      .then(async () => {
        ...
        premiumContentStatus.textContent = "Abide content added.";
